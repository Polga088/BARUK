...
echo "  Web   : ${WEB_URL:-http://localhost:8090}"
echo "  Owner : ${OWNER_URL:-http://localhost:8091}"
echo "  Admin : ${ADMIN_URL:-http://localhost:8092}"
echo "  Staff : ${STAFF_URL:-http://localhost:8093}"
echo ""
echo "Health: curl ${WEB_URL:-http://localhost:8090}/api/health"
